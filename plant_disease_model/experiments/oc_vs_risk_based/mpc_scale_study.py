...
from plant_disease_model.experiments import simple_controls, equal_per_host_control, no_control


def with_mpc_direct_rate(target_settings):
    ...
    target_settings.set_display_name_addendum("MPC absolute")
...
def with_sensitivity_control(target_settings):
    target_settings.set_display_name_addendum("sensitivity control")
    return target_settings
...
class MPCScaleStudy(PDAblationStudy):

    def get_cull_or_thin(self):
        ...
        return cull_or_thin_2_by_2_nodes

    def __init__(self, baseline_mod=None, cost_scaling=3.0):
        self.cost_scaling = cost_scaling
        ablation_list = [
            with_mpc_direct_rate,
